...
from FetchOptionResult import FetchOptionResult 
...
def main():
    ...
    fetchOptionResult = FetchOptionResult()
    ...
    for ticker in tickers:
        ...
        fetchOptionResult.add(ticker, options_data.shape[0])
